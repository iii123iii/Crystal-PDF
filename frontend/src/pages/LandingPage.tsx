  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative overflow-x-hidden">
      ...
      <style>{`
        ...
        /* Crystal prism — scales down on smaller screens */
        .prism {
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden>
        <div className="absolute -top-[30%] left-1/2 -translate-x-1/2 w-[min(900px,120vw)] h-[min(900px,120vw)] rounded-full"
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 sm:px-6 h-16">
          <Link to="/" className="flex items-center gap-2 sm:gap-2.5 group">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gradient-to-br from-brand-500 to-blue-400 flex items-center justify-center
              ...
              <Gem size={13} className="text-white sm:size-[14px]" />
            </div>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6
        ...
        <div className="max-w-2xl">
          <h1 className="font-display font-semibold tracking-tight leading-[1.1]
                         text-[clamp(2rem,7vw,4.8rem)] sm:text-[clamp(2.2rem,5.5vw,4.8rem)] text-white anim-reveal">
            Every<span className="hidden sm:inline"><br /></span> PDF tool<span className="hidden sm:inline"><br /></span> you'll ever{' '}
