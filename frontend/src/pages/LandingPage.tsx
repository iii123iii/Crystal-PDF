  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/[.04]"
        ...
        <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-x-4 gap-y-2 px-4 py-3 sm:px-6 sm:py-0 sm:min-h-16">
          <Link to="/" className="flex min-h-11 shrink-0 items-center gap-2.5 group">
          ...
          <div className="flex w-full items-center gap-2 sm:w-auto">
            <Link to="/login"
              className="inline-flex min-h-11 flex-1 items-center justify-center whitespace-nowrap text-sm text-slate-400 hover:text-white px-4 py-2 transition-colors sm:flex-none">
              Sign in
            </Link>
            <Link to="/register"
              className="inline-flex min-h-11 flex-1 items-center justify-center whitespace-nowrap sm:flex-none text-sm font-medium text-blue-300 bg-brand-500/15 hover:bg-brand-500/25
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6
                          pt-12 pb-16 sm:pt-20 sm:pb-24 lg:pt-32 lg:pb-36
                          grid lg:grid-cols-[minmax(0,1fr),auto] items-center gap-12">
        {/* Text column */}
        <div className="min-w-0 max-w-2xl">
          <h1 className="font-display font-semibold tracking-tight leading-[1.1]
            ...
            Every<br className="hidden lg:block" /> PDF tool<br className="hidden lg:block" /> you'll ever{' '}
        ...
        {/* Crystal visual */}
        <div className="hidden lg:flex items-center justify-center anim-fade anim-d4">
          <div className="prism">
            {/* Inner facets */}
      ...
      <section className="relative z-10 dot-grid">
        <div className="max-w-6xl mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:py-32">
          {/* Section header */}
          <div className="max-w-lg mb-8 sm:mb-14">
            ...
            <h2 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-semibold
              ...
              Everything in<br className="hidden lg:block" /> one workspace
            </h2>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {tools.map((t) => (
              <div key={t.name} className="tool-card min-w-0 rounded-2xl p-4 sm:p-5 cursor-default group">
      ...
      <section className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-3xl mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:py-32">
      ...
      {/* ── CTA ────────────────────────────────────────────── */}
      <section className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 py-16 sm:px-6 sm:py-28 lg:py-36 text-center">
          {/* Soft top glow */}
      ...
      <footer className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col items-start sm:flex-row sm:items-center justify-between gap-4">
