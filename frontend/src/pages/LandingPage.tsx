  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/[.04]"
        ...
        {mobileMenuOpen && (
          <div className="sm:hidden border-t border-white/[.04] anim-fade">
            <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col gap-3">
              <Link to="/login"
                className="text-sm text-slate-400 hover:text-white px-4 py-3 rounded-lg
              ...
              <Link to="/register"
                className="text-sm font-medium text-blue-300 bg-brand-500/15 hover:bg-brand-500/25
                           border border-brand-500/25 hover:border-brand-500/40
                           px-4 py-3 rounded-lg transition-all text-center"
                onClick={() => setMobileMenuOpen(false)}>
                Get started
              </Link>
            </div>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6
        ...
        <div className="max-w-2xl">
          <h1 className="font-display font-semibold tracking-tight leading-[1.1]
                         text-[clamp(1.8rem,7vw,4.8rem)] text-white anim-reveal">
          ...
          <p className="mt-5 sm:mt-7 text-[clamp(0.95rem,2.5vw,1.2rem)] leading-relaxed
          ...
          <div className="mt-8 sm:mt-10 flex flex-wrap gap-3 anim-reveal anim-d3">
            <Link to="/register"
              className="inline-flex items-center gap-2 px-5 sm:px-6 py-3 sm:py-3.5 rounded-xl text-[14px] sm:text-[15px] font-medium
      ...
      <section className="relative z-10 dot-grid">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32">
          ...
          <div className="max-w-lg mb-10 sm:mb-14">
            ...
            <p className="mt-4 text-slate-500 leading-relaxed text-[14px] sm:text-[15px]">
                ...
                <div className="flex items-start gap-4 sm:gap-5">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center
                      ...
                      <s.icon size={18} className="text-blue-400 sm:size-5" strokeWidth={1.6} />
                    </div>
                  </div>
      ...
      <section className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28 md:py-36 text-center">
          ...
          <div className="relative flex flex-wrap justify-center gap-3">
            <Link to="/register"
              className="inline-flex items-center gap-2 px-6 sm:px-7 py-3 sm:py-3.5 rounded-xl text-[14px] sm:text-[15px] font-medium
                         text-white bg-gradient-to-b from-brand-500 to-brand-600
                         shadow-[0_2px_24px_rgba(45,98,255,.35)]
                         hover:shadow-[0_4px_32px_rgba(45,98,255,.5)]
