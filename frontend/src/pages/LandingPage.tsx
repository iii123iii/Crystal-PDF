  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/[.04]"
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-3 px-4 sm:px-6 py-3 min-h-16">
          ...
          <div className="flex shrink-0 items-center gap-1 sm:gap-2">
            <Link to="/login"
              className="hidden sm:inline-block text-sm text-slate-400 hover:text-white px-4 py-2 transition-colors">
              Sign in
            </Link>
            <Link to="/register"
              className="text-[13px] sm:text-sm font-medium text-blue-300 bg-brand-500/15 hover:bg-brand-500/25
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6
        ...
        <div className="max-w-2xl">
          <h1 className="font-display font-semibold tracking-tight leading-[1.1]
                         text-[clamp(2.15rem,13vw,4.8rem)] sm:text-[clamp(2.2rem,5.5vw,4.8rem)] text-white anim-reveal break-words">
      ...
      <section className="relative z-10 dot-grid">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {tools.map((t) => (
              <div key={t.name} className="tool-card rounded-2xl p-5 cursor-default group min-w-0">
      ...
      <section className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28 md:py-36 text-center">
          ...
          <h2 className="font-display text-[clamp(2rem,12vw,4.5rem)] sm:text-[clamp(2.4rem,5.5vw,4.5rem)] font-semibold
                         tracking-tight leading-tight sm:leading-[.95] text-white mb-10 relative">
