    ...
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6
        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-10 flex flex-col min-[380px]:flex-row min-[380px]:flex-wrap gap-3 anim-reveal anim-d3">
            <Link to="/register"
      ...
      <section className="relative z-10 dot-grid">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-24 md:py-32">
          ...
          <div className="grid grid-cols-1 min-[380px]:grid-cols-2 sm:grid-cols-4 gap-3">
            {tools.map((t) => (
              <div key={t.name} className="tool-card rounded-2xl p-5 min-h-[148px] cursor-default group">
      ...
      <section className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-24 sm:py-28 md:py-36 text-center">
          ...
          <h2 className="font-display text-[clamp(2.1rem,10vw,4.5rem)] font-semibold
                         tracking-tight leading-[1.02] md:leading-[.95] text-white mb-10 relative">
            Start working with<br />
            your PDFs today.
          </h2>
          <div className="relative flex flex-wrap justify-center gap-3">
            <Link to="/register"
              className="inline-flex w-full min-[380px]:w-auto items-center justify-center gap-2 px-7 py-3.5 rounded-xl text-[15px] font-medium
                         text-white bg-gradient-to-b from-brand-500 to-brand-600
                         shadow-[0_2px_24px_rgba(45,98,255,.35)]
                         hover:shadow-[0_4px_32px_rgba(45,98,255,.5)]
