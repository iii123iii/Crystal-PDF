  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/[.04]"
        ...
        <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-2 px-4 sm:px-6 min-h-16 py-2">
          <Link to="/" className="flex shrink-0 items-center gap-2 sm:gap-2.5 min-h-11 group">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <Link to="/login"
              className="inline-flex items-center justify-center min-h-11 text-sm whitespace-nowrap text-slate-400 hover:text-white px-2 sm:px-4 py-2 transition-colors">
              Sign in
            </Link>
            <Link to="/register"
              className="inline-flex items-center justify-center min-h-11 text-sm whitespace-nowrap font-medium text-blue-300 bg-brand-500/15 hover:bg-brand-500/25
