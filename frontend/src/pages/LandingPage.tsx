  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-[#050e18] text-slate-200 relative">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/[.04]"
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 sm:px-6 h-16 gap-3">
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <span className="font-display text-lg font-semibold tracking-tight text-white whitespace-nowrap">
              Crystal<span className="text-blue-400">PDF</span>
            </span>
          </Link>
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            <Link to="/login"
              className="text-sm text-slate-400 hover:text-white px-2 sm:px-4 py-2 transition-colors whitespace-nowrap">
              Sign in
            </Link>
            <Link to="/register"
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6
        ...
        <div className="max-w-2xl min-w-0 landing-copy">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3 anim-reveal anim-d3">
            <Link to="/register"
