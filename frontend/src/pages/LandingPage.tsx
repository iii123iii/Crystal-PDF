  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/[.04]"
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-3 px-4 sm:px-6 h-16 min-w-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <Link to="/register"
              className="hidden sm:inline-flex text-sm font-medium text-blue-300 bg-brand-500/15 hover:bg-brand-500/25
      ...
      <section className="relative z-10 max-w-6xl mx-auto
                          px-4 sm:px-6 pt-14 pb-16 sm:pt-20 sm:pb-24 md:pt-32 md:pb-36
                          grid md:grid-cols-[1fr,auto] items-center gap-12">
        {/* Text column */}
        <div className="max-w-2xl">
          <h1 className="font-display font-semibold tracking-tight leading-[1.08]
                         text-[clamp(2.4rem,12vw,4.8rem)] text-white anim-reveal max-w-full">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col min-[420px]:flex-row flex-wrap gap-3 anim-reveal anim-d3">
            <Link to="/register"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32">
          ...
          <div className="max-w-lg mb-14">
            ...
            <h2 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-semibold
              ...
              Everything in<br /> one workspace
            </h2>
