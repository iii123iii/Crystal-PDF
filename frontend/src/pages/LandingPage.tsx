  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden>
        <div className="absolute -top-[30%] left-1/2 -translate-x-1/2 w-[400px] h-[400px] sm:w-[900px] sm:h-[900px] rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(45,98,255,.1) 0%, transparent 65%)' }} />
        <div className="absolute top-[55%] -right-[10%] w-[250px] h-[250px] sm:w-[500px] sm:h-[500px] rounded-full"
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 sm:px-6 h-14 sm:h-16">
          <Link to="/" className="flex items-center gap-2 sm:gap-2.5 group">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gradient-to-br from-brand-500 to-blue-400 flex items-center justify-center
              ...
              <Gem size={12} className="text-white sm:size-[14px]" />
            </div>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6
                          pt-16 sm:pt-20 pb-20 sm:pb-24 md:pt-32 md:pb-36
        ...
        <div className="max-w-2xl">
          <h1 className="font-display font-semibold tracking-tight leading-[1.1]
                         text-[clamp(2rem,7vw,4.8rem)] text-white anim-reveal">
      ...
      <section className="relative z-10 dot-grid">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-24 md:py-32">
          ...
          <div className="max-w-lg mb-10 sm:mb-14">
            ...
            <p className="mt-4 text-slate-500 leading-relaxed text-sm sm:text-[15px]">
            ...
            {tools.map((t) => (
              <div key={t.name} className="tool-card rounded-2xl p-4 sm:p-5 cursor-default group">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-blue-400/[.08] border border-blue-400/[.12]
                                ...
                                transition-colors">
                  <t.icon size={16} className="text-blue-400 sm:size-[18px]" strokeWidth={1.8} />
                </div>
                ...
                <div className="flex items-start gap-3 sm:gap-5">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center
                      ...
                      <s.icon size={16} className="text-blue-400 sm:size-[20px]" strokeWidth={1.6} />
                    </div>
                  </div>

                  {/* Right: text */}
                  <div className="pt-0.5 sm:pt-1">
                    <p className="text-[10px] sm:text-xs font-medium text-brand-400/60 tracking-wider mb-1">
                      Step {s.num}
                    </p>
      ...
      <section className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28 md:py-36 text-center">
          ...
          <h2 className="font-display text-[clamp(2rem,7vw,4.5rem)] font-semibold
                         tracking-tight leading-[.95] text-white mb-8 sm:mb-10 relative">
            Start working with<br />
            your PDFs today.
          </h2>
          <div className="relative flex flex-col sm:flex-row flex-wrap justify-center gap-2.5 sm:gap-3">
            <Link to="/register"
