    ...
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6
        ...
        <div className="max-w-2xl">
          <h1 className="font-display font-semibold tracking-tight leading-[1.1]
                         text-[clamp(2rem,13vw,4.8rem)] sm:text-[clamp(2.2rem,5.5vw,4.8rem)] text-white anim-reveal">
          ...
          <p className="mt-5 sm:mt-7 text-base sm:text-[clamp(1rem,1.8vw,1.2rem)] leading-relaxed
      ...
      <section className="relative z-10 dot-grid">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
            {tools.map((t) => (
              <div key={t.name} className="tool-card rounded-xl sm:rounded-2xl p-4 sm:p-5 min-h-[126px] sm:min-h-0 cursor-default group">
              ...
              <div key={s.num}>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed max-w-[16rem] sm:max-w-sm">
                      {s.body}
                    </p>
                  </div>
                </div>
      ...
      <section className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28 md:py-36 text-center">
          ...
          <h2 className="font-display text-[clamp(2rem,13vw,4.5rem)] sm:text-[clamp(2.4rem,5.5vw,4.5rem)] font-semibold
                         tracking-tight leading-[1.02] sm:leading-[.95] text-white mb-8 sm:mb-10 relative">
      ...
      <footer className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          ...
          <p className="text-xs text-slate-700 text-center sm:text-right max-w-xs sm:max-w-none">
