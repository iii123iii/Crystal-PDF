  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/[.04]"
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-2 px-3 min-[480px]:px-4 sm:px-6 h-16">
          <Link to="/" className="flex shrink-0 items-center gap-1 min-[480px]:gap-2.5 min-h-11 group">
            <div className="w-6 h-6 min-[480px]:w-8 min-[480px]:h-8 rounded-lg bg-gradient-to-br from-brand-500 to-blue-400 flex items-center justify-center
                            shadow-lg shadow-brand-500/20 group-hover:shadow-brand-500/40 transition-shadow">
              <Gem size={14} className="text-white" />
            </div>
            <span className="font-display text-base min-[480px]:text-lg font-semibold tracking-tight text-white">
              Crystal<span className="text-blue-400">PDF</span>
            </span>
          </Link>
          <div className="flex shrink-0 items-center gap-1 min-[480px]:gap-2">
            <Link to="/login"
              className="inline-flex min-h-11 items-center justify-center whitespace-nowrap text-sm text-slate-400 hover:text-white px-1.5 min-[480px]:px-4 py-2 transition-colors">
              Sign in
            </Link>
            <Link to="/register"
              className="inline-flex min-h-11 items-center justify-center whitespace-nowrap text-sm font-medium text-blue-300 bg-brand-500/15 hover:bg-brand-500/25
                         border border-brand-500/25 hover:border-brand-500/40
                         px-2 min-[480px]:px-4 py-2 rounded-lg transition-all">
              Get started
            </Link>
          </div>
        </div>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6
                          ...
                          grid md:grid-cols-[minmax(0,1fr),auto] items-center gap-8 lg:gap-12">
        {/* Text column */}
        <div className="max-w-2xl">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col min-[480px]:flex-row min-[480px]:flex-wrap gap-3 anim-reveal anim-d3">
            <Link to="/register"
              className="inline-flex justify-center items-center gap-2 px-6 py-3.5 rounded-xl text-[15px] font-medium
      ...
      <section className="relative z-10 dot-grid">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-32">
          {/* Section header */}
          <div className="max-w-lg mb-8 sm:mb-14">
          ...
          <div className="grid grid-cols-1 min-[400px]:grid-cols-2 lg:grid-cols-4 gap-3">
            {tools.map((t) => (
              <div key={t.name} className="tool-card min-w-0 break-words rounded-2xl p-5 cursor-default group">
      ...
      {/* ── CTA ────────────────────────────────────────────── */}
      <section className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-36 text-center">
          {/* Soft top glow */}
          ...
          <div className="relative flex flex-col min-[480px]:flex-row min-[480px]:flex-wrap justify-center gap-3">
            <Link to="/register"
              className="inline-flex justify-center items-center gap-2 px-7 py-3.5 rounded-xl text-[15px] font-medium
                         text-white bg-gradient-to-b from-brand-500 to-brand-600
                         shadow-[0_2px_24px_rgba(45,98,255,.35)]
                         hover:shadow-[0_4px_32px_rgba(45,98,255,.5)]
