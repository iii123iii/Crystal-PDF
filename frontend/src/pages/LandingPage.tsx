        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-3 px-4 sm:px-6 h-16">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link to="/login"
              aria-label="Sign in"
              title="Sign in"
              className="inline-flex min-h-11 min-w-11 items-center justify-center text-sm text-slate-400 hover:text-white
                         px-3 min-[380px]:px-4 py-2 transition-colors">
              <LogIn size={18} className="min-[380px]:hidden" aria-hidden="true" />
            ...
            <Link to="/register"
              className="inline-flex min-h-11 items-center text-sm font-medium text-blue-300 bg-brand-500/15 hover:bg-brand-500/25
                         ...
                         px-3 min-[380px]:px-4 py-2 rounded-lg transition-all whitespace-nowrap">
              Get started
            </Link>
          </div>
        </div>
