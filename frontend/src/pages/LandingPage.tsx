  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/[.04]"
        ...
        <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6 sm:py-0 sm:h-16">
          ...
          <div className="flex w-full items-center gap-2 sm:w-auto">
            <Link to="/login"
              className="flex min-h-11 flex-1 items-center justify-center whitespace-nowrap text-sm text-slate-400 hover:text-white px-4 py-2 transition-colors sm:flex-none">
              Sign in
            </Link>
            <Link to="/register"
              className="flex min-h-11 flex-1 items-center justify-center whitespace-nowrap text-sm font-medium text-blue-300 bg-brand-500/15 hover:bg-brand-500/25 sm:flex-none
      ...
      <footer className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-start sm:items-center justify-between flex-wrap gap-4">
