  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/[.04]"
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-3 px-4 sm:px-6 h-14 sm:h-16 min-w-0">
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            <Link to="/login"
              className="whitespace-nowrap text-xs sm:text-sm text-slate-400 hover:text-white px-2 sm:px-4 py-2 transition-colors">
              Sign in
            </Link>
            <Link to="/register"
              className="whitespace-nowrap text-xs sm:text-sm font-medium text-blue-300 bg-brand-500/15 hover:bg-brand-500/25
                         ...
                         px-2.5 sm:px-4 py-2 rounded-lg transition-all">
              Get started
            </Link>
          </div>
        </div>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6
        ...
        <div className="max-w-2xl min-w-0">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col min-[380px]:flex-row min-[380px]:flex-wrap gap-3 anim-reveal anim-d3">
            <Link to="/register"
              className="inline-flex items-center justify-center gap-2 w-full min-[380px]:w-auto px-6 py-3.5 rounded-xl text-[15px] font-medium
        ...
        {/* Crystal visual — smaller on mobile, full on md+ */}
        <div className="flex items-center justify-center anim-fade anim-d4 scale-75 sm:scale-90 md:scale-100 origin-center">
          <div className="prism max-w-full">
            {/* Inner facets */}
      ...
      <section className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-28 md:py-36 text-center">
          ...
          <h2 className="font-display text-[clamp(1.85rem,5.5vw,4.5rem)] font-semibold
                         tracking-tight leading-[.95] text-white mb-10 relative">
            Start working with<br />
            your PDFs today.
          </h2>
          <div className="relative flex flex-col min-[380px]:flex-row flex-wrap justify-center gap-3 w-full max-w-md mx-auto min-[380px]:max-w-none">
            <Link to="/register"
              className="inline-flex items-center justify-center gap-2 w-full min-[380px]:w-auto px-7 py-3.5 rounded-xl text-[15px] font-medium
                         text-white bg-gradient-to-b from-brand-500 to-brand-600
                         shadow-[0_2px_24px_rgba(45,98,255,.35)]
                         hover:shadow-[0_4px_32px_rgba(45,98,255,.5)]
