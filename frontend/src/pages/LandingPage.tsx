...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050e18] text-slate-200 relative overflow-x-clip">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/[.04]"
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-3 px-4 sm:px-6 h-16">
          <Link to="/" className="flex min-w-0 items-center gap-2.5 group">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-brand-500 to-blue-400 flex shrink-0 items-center justify-center
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6
        ...
        <div className="max-w-2xl">
          <h1 className="font-display font-semibold tracking-tight leading-[1.1]
                         text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white anim-reveal">
          ...
          <p className="mt-6 sm:mt-7 text-base sm:text-lg md:text-xl leading-relaxed
          ...
          <div className="mt-8 sm:mt-10 flex max-w-sm flex-col gap-3 sm:max-w-none sm:flex-row sm:flex-wrap anim-reveal anim-d3">
            <Link to="/register"
      ...
      {/* ── CTA ────────────────────────────────────────────── */}
      <section className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-24 sm:py-28 md:py-36 text-center">
          {/* Soft top glow */}
          ...
          <h2 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold
                         tracking-tight leading-[.95] text-white mb-10 relative">
            Start working with<br />
            your PDFs today.
          </h2>
          <div className="relative mx-auto flex max-w-sm flex-col justify-center gap-3 sm:max-w-none sm:flex-row sm:flex-wrap">
            <Link to="/register"
      ...
      <footer className="relative z-10 border-t border-white/[.04]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-7 sm:py-8 flex flex-col items-center justify-between gap-3 text-center sm:flex-row sm:text-left">
