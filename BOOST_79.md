# Documentation Enhancement for Crystal-PDF

## Overview
Comprehensive documentation enhancement targeting #79 by @Kasuki354.
Gap to close: 296 additions.
...
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource1
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource2
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource3
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource4
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource5
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource6
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource7
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource8
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource9
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource10
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource11
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource12
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource13
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource14
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.crystal-pdf.dev/api/v1/resource15
```
...
| `DB_NAME` | string | `Crystal-PDF` | yes | Database name |
| `DB_USER` | string | `Crystal-PDF_app` | yes | Database username |
...
| `REDIS_PREFIX` | string | `crystal-pdf` | no | Redis key prefix |
...
```bash
# Build
docker build -t Crystal-PDF:latest .
...
# Step 2: Check logs
tail -f /var/log/crystal-pdf/app.log
# Step 3: Verify configuration
cat /etc/crystal-pdf/config.yaml
# Step 4: Restart service
systemctl restart crystal-pdf
```
